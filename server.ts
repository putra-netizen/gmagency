...
async function startServer() {
  if (process.env.NODE_ENV !== 'production') {
    // Dynamic import: 'vite' hanya di-load kalau BENERAN jalan di dev lokal.
    // startServer() sendiri hanya dipanggil kalau !process.env.VERCEL (lihat di
    // bawah), jadi baris ini tidak akan pernah dieksekusi/dimuat sama sekali di
    // Vercel — package 'vite' yang berat & rumit untuk di-bundle serverless
    // sepenuhnya tidak tersentuh di production.
